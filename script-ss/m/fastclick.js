...
/*
* while trigger  other elements(element B)' clicke event in some (element A) click callback
* this.targetElement still refer to element A,supply a trigger method by
* fasktclick to correct it
*/
FastClick.prototype.triggerClick = function(targetElement ,event){
    this.targetElement = targetElement
    this.sendClick(targetElement, event || {})
